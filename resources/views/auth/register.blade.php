    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="glass-effect rounded-2xl shadow-2xl p-8 animate-fadeInUp">
            ...
            <div class="text-center mb-8 animate-fadeIn delay-1">
                ...
                <p class="text-gray-600">Sign up to get started with us</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div class="animate-fadeInUp delay-2">
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            autofocus 
                            autocomplete="name"
                            class="input-focus w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300"
                ...
                <!-- Submit Button -->
                <div class="animate-fadeInUp delay-5 pt-2">
                    <button 
                        type="submit" 
        ...
        <!-- Footer -->
        <div class="text-center mt-6 animate-fadeIn delay-5">
